...
import { Layout, Text, Button, Autocomplete, AutocompleteItem } from '@ui-kitten/components';
...
const SearchPage = () => {
    ...
    const onSelect = (index) => {
        ...
        getWeatherData(currentSelection.coord.lon, currentSelection.coord.lat).then((res) => {
    ...
    return (
        <Layout style={globalStyles.container}>
            ...
            <Autocomplete placeholder="Place your Text" value={value} placement={placement} onChangeText={onChangeText} onSelect={onSelect}>
